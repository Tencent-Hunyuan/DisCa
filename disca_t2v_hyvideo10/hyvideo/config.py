...
def add_disca_args(parser: argparse.ArgumentParser):
    group = parser.add_argument_group(title="DISCA args")

    group.add_argument(
        "--predictor-path",
        type=str,
        default=None,
        help="Path to the predictor checkpoint.",
    )
    group.add_argument(
        "--step-list",
        type=int,
        nargs="+",
        default=[0, 1, 2, 5, 9, 13, 17, 19],
        help="Step list for DISCA.",
    )
    return parser